...
public interface Connection {
	 ...
	 */
	public ResponseCommand invoke(final RequestCommand requestCommand, long time, TimeUnit timeUnit) throws InterruptedException,
	 ...
	 * @param listener
	 */
	public void send(final RequestCommand requestCommand, SingleRequestCallBackListener listener, long time, TimeUnit timeUnit)
			throws NotifyRemotingException;
